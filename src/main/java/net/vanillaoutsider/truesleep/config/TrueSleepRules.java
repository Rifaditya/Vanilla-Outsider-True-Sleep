...
public class TrueSleepRules {
        ...
        public static final GameRule<Boolean> MOBS_FROZEN = GameRulesInvoker.invokeRegisterBoolean(
                        "truesleep_freeze_mobs",
                        TRUE_SLEEP_CATEGORY, true);
        public static final GameRule<Boolean> WORKER_MOBS_FROZEN = GameRulesInvoker
                        .invokeRegisterBoolean("truesleep_freeze_workers", TRUE_SLEEP_CATEGORY,
                                        defaultWorkerMobsFrozen);
